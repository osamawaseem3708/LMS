...
<div class="wrapper rounded bg-white" id="update_course" style="width: 90%">
    <div style="float: left">
        <a href="<?php echo Yii::$app->getHomeUrl()."users/sdashboard";?>" class="btn btn-primary">Back</a>
    </div>
    <div class="h3" style="padding: 2%;text-align: center">Student Enrolled Courses</div>
...
<!--    data-bs-toggle="modal" data-bs-target="#staticBackdrop"      -->
        ...
        <td><?php echo $corse['estatus']; ?></td>
        <td><a class="btn btn-primary" style="color: white" href="/student/web/users/sdeleteenroll?id=<?php echo $corse['eid']; ?>">Remove</a>  &nbsp;
