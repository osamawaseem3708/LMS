...
<div class="wrapper rounded bg-white" id="update_course" style="width: 90%">
    ...
    <div class="h3" style="padding: 2%;text-align: center">Course Wise Student Enrollment</div>
...
<!--    data-bs-toggle="modal" data-bs-target="#staticBackdrop"      -->
        ...
        <td><?php echo $corse['total_students']; ?></td>
        <td><a class="btn btn-primary" style="color: white" href="/student/web/users/tstudentdetail?id=<?php echo $corse['cid']; ?>">View Students</a>  &nbsp;
